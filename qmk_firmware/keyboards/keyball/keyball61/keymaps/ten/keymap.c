...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL,   KC_LGUI, MO(2),     KC_LALT,   KC_BTN2,   KC_SPC,	 KC_BTN1,     KC_SPC ,   KC_ENT,                                     KC_MINS,   KC_EQL
  ),
  ...
  [1] = LAYOUT(
    ...
    _______,   _______, _______,   _______,   _______,   KC_END,    _______,    _______,   KC_PGDN,   _______,   _______,   _______,   _______,   _______,
    _______,   _______, _______,   _______,   _______,   KC_ENT,	  KC_BTN3,    _______,   _______,                                    _______,   _______
  ),
  [2] = LAYOUT(
    ...
    _______,   _______, _______,   _______,   _______,   _______,   CPI_D100,   CPI_I100,  _______,   KC_MUTE,   KC_VOLD,   KC_VOLU,   _______,   _______,
