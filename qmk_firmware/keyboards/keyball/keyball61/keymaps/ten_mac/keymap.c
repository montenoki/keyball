...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL,   KC_LALT, MO(2),     KC_LGUI,   KC_BTN2,   KC_SPC,	 KC_BTN1,     MO(1),     KC_ENT,                                     KC_MINS,   KC_EQL
  ),

  [1] = LAYOUT(
    KC_GRV,    KC_F1,   KC_F2,     KC_F3,     KC_F4,     KC_F5,                            KC_F6,     KC_F7,     KC_F8,     KC_F9,     KC_F10,    KC_DEL,
    _______,   _______, KC_BSPC,   KC_UP,     KC_DEL,    KC_HOME,                          KC_PGUP,   KC_BSPC,   KC_UP,     KC_DEL,    _______,   _______,
